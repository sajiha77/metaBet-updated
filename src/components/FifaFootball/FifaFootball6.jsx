...
import { Statistics12, Statistics13 } from "./FifaFootballData";
...
function FifaFootball() {
  ...
  const src = "https://youtu.be/DbqudKskqjA";
      ...
      <Container>
        <StatContainer>
          <div className="portfolio">
            <img src={Netherlands} alt="Netherlands" width={149} />
            <span>Netherlands</span>
          </div>
          <div className="rectangle">
            <span>Statistic:</span>
            {Statistics12.map((item) => (
              <span>{item.name}</span>
            ))}
          </div>
          <div className="vs">
          ...
          <div className="rectangle">
            <span>Statistic:</span>
            {Statistics13.map((item) => (
              <span>{item.name}</span>
            ))}
          </div>
          <div className="portfolio">
            <img src={Argentina} alt="Argentina" width={150} />
            <span>Argentina</span>
          </div>
        </StatContainer>
        <Info>
