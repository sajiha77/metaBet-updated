...
import { Statistics10, Statistics11 } from "./FifaFootballData";
...
function FifaFootball() {
  ...
  const src = "https://youtu.be/kJLI8VTvrtA";
      ...
      <Container>
        <StatContainer>
          <div className="portfolio">
            <img src={Portugal} alt="Portugal" width={149} />
            <span>Portugal</span>
          </div>
          <div className="rectangle">
            <span>Statistic:</span>
            {Statistics10.map((item) => (
              <span>{item.name}</span>
            ))}
          </div>
          <div className="vs">
          ...
          <div className="rectangle">
            <span>Statistic:</span>
            {Statistics11.map((item) => (
              <span>{item.name}</span>
            ))}
          </div>
          <div className="portfolio">
            <img src={Switzerland} alt="Switzerland" width={150} />
