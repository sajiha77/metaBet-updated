...
import { Statistics8, Statistics9 } from "./FifaFootballData";
      ...
      <Container>
        <StatContainer>
          <div className="portfolio">
            <img src={Morroco} alt="Morroco" width={149} />
            <span>Morroco</span>
          </div>
          <div className="rectangle">
            <span>Statistic:</span>
            {Statistics8.map((item) => (
              <span>{item.name}</span>
            ))}
          </div>
          <div className="vs">
          ...
          <div className="rectangle">
            <span>Statistic:</span>
            {Statistics9.map((item) => (
              <span>{item.name}</span>
            ))}
          </div>
          <div className="portfolio">
            <img src={Portugal} alt="Portugal" width={150} />
            <span>Portugal</span>
          </div>
        </StatContainer>
        <Info>
